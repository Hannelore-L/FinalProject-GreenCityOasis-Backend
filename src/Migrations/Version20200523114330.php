 ...
 */
final class Version20200523114330 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE city (city_id INT AUTO_INCREMENT NOT NULL, city_country_id INT NOT NULL, city_zip SMALLINT NOT NULL, city_name VARCHAR(512) NOT NULL, city_province VARCHAR(512) NOT NULL, PRIMARY KEY(city_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
